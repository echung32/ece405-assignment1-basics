...
def _process_chunk(path: str, start: int, end: int, pattern: str):
...
def run_train_bpe(
    ...
    **kwargs,
    ...
    print(len(frequency), "unique pre-tokens found in the dataset.")
    ...
    while len(vocab) < vocab_size:
        ...
        for tok, count in list(frequency.items()):
            ...
            if merged:
                ...
                frequency[tok] -= count
                if frequency[tok] <= 0: del frequency[tok]
