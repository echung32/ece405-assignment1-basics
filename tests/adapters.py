...
from cs336_basics.module.swiglu import SiLU, SwiGLU
...
def run_swiglu(
    ...
    # Load the weights
    # Option 1: Use load_state_dict (if keys match)
...
def run_multihead_self_attention(
    ...
    """
    mha = MultiHeadSelfAttention(d_model=d_model, num_heads=num_heads, use_rope=False)
    mha.load_state_dict({
